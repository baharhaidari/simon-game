...
function checkColorSet() {
  ...
  //win
  else if (arrayInGame.length === arrayMain.length && arrayInGame.length !== 0)
    winLevel();
}
...
function playSound(soundName) {
  switch (soundName) {
    case "coin":
      new Audio(
        "https://pangilinanervin22.github.io/simon/res/coin_sound.wav"
      ).play();
      break;
    case "win":
    ...
    case "lose":
      new Audio(
        "https://pangilinanervin22.github.io/simon/res/lose.wav"
      ).play();
      break;
    case "try":
    ...
    case "start":
      new Audio(
        "https://pangilinanervin22.github.io/simon/res/start.wav"
      ).play();
      break;
    default:
  }
